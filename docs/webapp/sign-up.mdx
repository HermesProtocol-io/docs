...
1- Sign up [here](https://app.hermesprotocol.io/signup)
...
5- If you do not have one of the wallet extensions, they'll prompt you to Install them. Pick your favorite and proceed.
:::note
...
7 - You can setup the [2F Authentication](2FA) or skip the step by clicking the Sign-up button.
