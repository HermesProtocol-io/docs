...
To create a Wallet Monitor notification using the Hermes Protocol API, construct the request body according to the [general structure](/public-api/notification). For the `notificationParams` object, adhere to the Body structure outlined below:
...
In this section we only show the notification parameters specific for wallet monitor. To see the rest of the body structure please check the [notification](/public-api/notification)
