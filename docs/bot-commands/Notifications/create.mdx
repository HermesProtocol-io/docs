...
title: ➕ Create
sidebar_position: 1
description: This command allow you to create a new notification. You can create notifications for NFTs, Governance, Price and more.
---
...
This command allow you to create a new notification. You can create notifications for NFTs, Governance, Price and more.
...
<Tabs groupId="alerts">
  <TabItem value="dms" label="DMs" default>
    <CodeBlock>
      /notification create price blockchain:Terra dex:Terraswap pair:LUNA /
      LunaX Pair price:0.9 type:lower than
    </CodeBlock>
  </TabItem>
  <TabItem value="server" label="Server">
    <CodeBlock title="with channel">
      /notification create price blockchain:Terra dex:Terraswap pair:LUNA /
      LunaX Pair price:0.9 type:lower than channel:#prices
    </CodeBlock>
    <p>or</p>
